...
function showTxt(event) {
    ...
    if (ContainingBox) {
        ...
        var displayTxt = '<div class="bubble-message bottom" ><button class="delbtn">X</button><button class="updatebtn">Select</button> <p class="titleTxt"><b> ' + titleName + '</b></p><p class="descriptionTxt">' + descriptionValue + '</p></div>';
